  ...
  const steps = [
    {
      ...
      description: 'Muat turun aplikasi Tune Talk melalui App Store atau Google Play untuk memulakan pendaftaran anda.',
      time: '± 2 minit',
      image: 'images/tune-talk-app-mockup.png',
      list: [
    ...
    },
    {
      ...
      description: 'Gunakan aplikasi HaloGo Partner untuk mengurus jualan, pelanggan, prestasi dan komisen anda dalam satu tempat.',
      time: '± 2 minit',
      image: 'images/halogo-dashboard-mockup.png',
      list: [
        'Muat turun aplikasi HaloGo Partner',
        'Log masuk menggunakan akaun yang didaftarkan',
        'Terokai dashboard jualan dan komisen'
      ],
    ...
    },
    {
      ...
      description: 'Lengkapkan profil partner dan maklumat pembayaran untuk mula menjual serta membina pendapatan bersama HaloGo.',
      time: '± 5 minit',
      image: 'images/halogo-success-mockup.png',
      list: [
        'Lengkapkan maklumat profil partner',
        'Masukkan maklumat akaun bank dengan tepat',
        'Aktifkan akaun dan mula menjual pelan Halo'
      ],
      statusTitle: 'Akaun Partner',
      statusCopy: 'Berjaya diaktifkan',
      badgeTitle: 'Sedia Menjana',
      badgeCopy: 'Mulakan jualan anda'
    }
  ];
  ...
  const update = (index, focusTab = false) => {
    ...
    changeTimer = window.setTimeout(() => {
      ...
      if (nextIndex === steps.length - 1) {
        cta.textContent = 'Daftar Sekarang';
